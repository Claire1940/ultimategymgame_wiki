...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Ultimate Gym Game Wiki',
    description: 'Copyright and intellectual property information for Ultimate Gym Game Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Ultimate Gym Game Wiki',
      description: 'Copyright and intellectual property information for Ultimate Gym Game Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Ultimate Gym Game Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Ultimate Gym Game Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Ultimate Gym Game Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Ultimate Gym Game Developers</strong> - Creators of the Ultimate Gym Game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Ultimate Gym Game</strong> - Trademark of the game developers</li>
              <li><strong>Ultimate Gym Game Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Ultimate Gym Game Wiki.
            </p>
            ...
            <p>
              ...
              Ultimate Gym Game Wiki<br />
              Email: <a href="mailto:dmca@ultimategymgame.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@ultimategymgame.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Ultimate Gym Game Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Ultimate Gym Game Wiki (ultimategymgame.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@ultimategymgame.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@ultimategymgame.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@ultimategymgame.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@ultimategymgame.wiki</a>
            </p>
            <p>
